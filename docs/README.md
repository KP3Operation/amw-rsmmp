...
|    `SIMRS_OTP_MESSAGE`    | Kode OTP anda untuk masuk ke aviat web mobile adalah :otpcode | The OTP message template. Please do not remove the ":otpcode" placeholder, because this is a placeholder that will be replace with the otp code |
