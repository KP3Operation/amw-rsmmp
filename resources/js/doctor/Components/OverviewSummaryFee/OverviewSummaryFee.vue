    ...
    <section class="mt-5">
        <div class="d-flex align-items-center justify-content-between col-gap-20 mb-3">
            ...
            <button class="btn btn-filter-fee p-0"
                    :class="showFilter ? 'bg-blue-500' : ''"
                    @click="showFilter = !showFilter">
                <i class="bi bi-filter-right fs-2 icon-blue-500"
                   :class="showFilter ? 'text-white' : 'text-blue-500'"></i>
            </button>
        </div>
        ...
        <div class="filter-homepage-summary-fee p-0 mb-3" :class="showFilter ? 'expand' : ''">
            <form class="d-flex col-gap-8 align-items-end" @submit.prevent="filterSummaryFee" @keydown="filterForm.onKeydown($event)">
                <div>
                    ...
                    <input type="date" name="start_date" v-model="filterForm.start_date" id="dari" class="form-control mt-2">
