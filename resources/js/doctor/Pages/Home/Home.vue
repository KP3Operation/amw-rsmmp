        ...
        <div class="px-4 mt-5">
            ...
            <!-- <section class="mt-5">
                ...
                <div id="overview-jadwal-konsultasi" class="carousel slide mt-3" data-bs-touch="true"
                        ...
                        <div class="carousel-item">
                            <div class="d-flex col-gap-20">
                                <div class="overview-slider-doctor">
                                    ...
                                    <p class="location">Unit Bedah Saraf dan Penyakit Dalam</p>
                                </div>
                                ...
                                <div class="overview-slider-doctor">
                                    ...
                                    <p class="location">Unit Isolasi Covid-19</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-indicators position-static mb-0">
                        <button type="button" data-bs-target="#overview-jadwal-konsultasi" data-bs-slide-to="0"
                                class="active" aria-current="true" aria-label="Slide 1"></button>

                        <button type="button" data-bs-target="#overview-jadwal-konsultasi" data-bs-slide-to="1"
            ...
            <!-- <section class="mt-5">
                ...
                <div id="overview-rawat-inap" class="carousel slide mt-3" data-bs-touch="true" data-bs-ride="carousel">
                        ...
                        <div class="carousel-item active">
                            <div class="d-flex col-gap-20">
                                <div class="overview-slider-doctor">
                                    ...
                                    <p class="location">Ruang Perawatan Intensif Kardiotoraks (Ruang PICU)</p>
                                </div>
                                ...
                                <div class="overview-slider-doctor">
                                    ...
                                    <p class="location">Ruang Intensive Care Unit (ICU)</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item">
                            <div class="d-flex col-gap-20">
                                <div class="overview-slider-doctor">
                                    ...
                                    <p class="location">Ruang Instalasi Gawat Darurat (IGD)</p>
                                </div>
                                ...
                                <div class="overview-slider-doctor">
                                    ...
                                    <p class="location">Ruangan Isolasi</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-indicators position-static mb-0">
                        <button type="button" data-bs-target="#overview-rawat-inap" data-bs-slide-to="0" class="active"
                                aria-current="true" aria-label="Slide 1"></button>

                        <button type="button" data-bs-target="#overview-rawat-inap" data-bs-slide-to="1"
                                aria-label="Slide 2"></button>
                    </div>
                </div>
            </section> -->
