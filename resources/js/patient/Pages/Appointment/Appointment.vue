            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div
                            class="d-flex col-gap-20 bg-gray-100 rounded px-2 py-2"
                        >
                            <div class="w-50">
                                ...
                                <p
                                    ...
                                    v-if="
                                        appointment.appointmentStatus === '01'
                                    "
                                >
                                    {{ $t("appointment.booking") }}
                                </p>
                                <p class="fs-5 fw-semibold" v-else>
                            ...
                            <div
                                class="w-50 text-end"
                                v-if="
                                    appointment.AppointmentQueFormattedNo !== ''
                                "
                            >
                ...
                >
                    <div class="text-center mt-3">
                        ...
                        <p
                            ...
                            v-html="$t('appointment.create_appointment_desc')"
                        ></p>
                    </div>
                </section>
            </div>
            ...
            >
                <section class="filter d-flex justify-content-between mt-4">
                    <p>
                        <span v-if="closeAppointments.length > 0">
                            {{ closeAppointments.length }}
                            {{ $t("appointment.indexed_appointment") }}
                        </span>
                    </p>
                    <button
                        id="filter-selesai"
                    ...
                    >
                        ...
                        >
                            <div class="w-50">
                                <p class="fs-6 text-gray-700">Status</p>
                                <p
                                    class="fs-5 fw-semibold text-red-500"
                                    v-if="
                                        appointment.appointmentStatus === '03'
                                    "
                                >
                ...
                >
                    <div class="text-center mt-3">
                        ...
                        <p
                            class="mt-2 text-gray-700"
                            v-html="$t('appointment.no_consultation_desc')"
                        ></p>
                    </div>
                </section>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                    <div class="d-flex align-items-center col-gap-8">
                        ...
                        <h5 class="modal-title">
                            {{
                                $t(
                                    "appointment.cancel_consultation_modal.title"
                                )
                            }}
                        </h5>
                    </div>
                ...
                <div class="modal-body">
                    <p class="text-start">
                        {{
                            $t("appointment.cancel_consultation_modal.message")
                        }}
                    </p>
                    <select
                        ...
                        v-model="cancelNote"
                        required
                        @change="cancelNoteChange()"
                    >
                        <option value="Batal Berobat">Batal Berobat</option>
                        <option value="Salah Pilih Dokter">
                            Salah Pilih Dokter
                        </option>
                        <option value="Salah Pilih Jadwal Dokter">
                            Salah Pilih Jadwal Dokter
                        </option>
                        <option value="Jadwal Dokter Berubah">
                            Jadwal Dokter Berubah
                        </option>
                        <option value="Ada Keperluan Lain">
                            Ada Keperluan Lain
                        </option>
                    </select>
                    <p class="fs-6 mt-2" style="font-style: italic; color: red">
                        {{ errorMessage }}
                    </p>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                    <div class="d-flex align-items-center col-gap-8">
                        ...
                        <h5 class="modal-title">
                            {{ $t("appointment.filter_modal.title") }}
                        </h5>
                    </div>
                    <button
                        type="button"
                    ...
                    <form action="" class="d-flex flex-column rows-gap-16">
                        <div>
                            <label for="member" class="d-block text-start">{{
                                $t("appointment.filter_modal.member")
                            }}</label>
                            <select
                                name="member"
                                id="member"
                        ...
                        <div>
                            <label for="unit" class="d-block text-start">{{
                                $t("appointment.filter_modal.unit")
                            }}</label>
                            <select
                                name="unit"
                                id="unit"
                            ...
                            >
                                <option value="" selected>
                                    {{ $t("appointment.filter_modal.all") }}
                                </option>
                                <option
                        ...
                        <div>
                            <label for="from" class="d-block text-start">{{
                                $t("appointment.filter_modal.from")
                            }}</label>
                            <input
                                type="date"
                                name="from"
