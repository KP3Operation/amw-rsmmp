...
<template>
    <div>
        ...
        <div class="px-4 pt-8">
            ...
            <div class="d-flex flex-column rows-gap-16 mt-4" v-for="family in families">
                <FamilyMemberCard
                    :name="family.name"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" @click="modalState.deleteFamilyConfirmation.hide()" aria-label="Close">
                    ...
                    <div class="modal-footer flex-nowrap">
                        <button @click="modalState.deleteFamilyConfirmation.hide()" type="button" class="w-50 btn btn-link" data-bs-dismiss="modal">Batal</button>
