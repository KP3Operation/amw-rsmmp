...
const fetchEncounterHistoryDetail = (registrationNo) => {
    ...
    apiRequest
        .get(
            `/api/v1/patient/medical/history/encounters/details?registration_no=${registrationNo}`
        )
        .then((response) => {
...
<template>
    <Header
        :title="$t('history.encounter_detail.title')"
        :with-back-url="true"
    ...
    <div class="px-4 pt-8">
        <div class="bg-white mt-4">
            <div class="header-detail-encounter">
                ...
                <div class="queue">
                    <p class="note">
                        {{ $t("history.encounter_detail.queue_no") }}
                    </p>
            ...
            <div class="d-flex flex-column rows-gap-16 mt-3 px-4">
                ...
                >
                    <div class="w-50">
                        <p class="fs-6 text-gray-700">
                            {{ $t("history.encounter_detail.registration_no") }}
                        </p>
                    ...
                    <div class="w-50 text-end">
                        <p class="fs-6 text-gray-700">
                            {{
                                $t("history.encounter_detail.consultation_date")
                            }}
                        </p>
                        ...
                        <p class="mt-2">
                            {{
                                convertDateTimeToDate(
                                    encounterDetail.registrationDate_yMdHms
                                )
                            }}
                            {{ encounterDetail.registrationTime }}
                        </p>
                    </div>
                </div>
                <div class="pb-3 border-bottom border-gray-400">
                    <p class="fs-6 text-gray-700">
                        {{ $t("history.encounter_detail.guarantor_name") }}
                    </p>
                    <p class="mt-2">{{ encounterDetail.guarantorName }}</p>
                </div>
                <div class="pb-3 border-bottom border-gray-400">
                    <p class="fs-6 text-gray-700">
                        {{ $t("history.encounter_detail.service_unit") }}
                    </p>
                ...
                <div class="pb-3">
                    <p class="fs-6 text-gray-700">
                        {{ $t("history.encounter_detail.diagnosis") }}
                    </p>
                    ...
                    <div
                        ...
                        id="accordion"
                        v-for="(encounter, index) in encountersDetail"
                    >
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button
                                    ...
                                    :data-bs-target="'#diagnosis-' + index"
                                    aria-expanded="false"
                                    aria-controls="diagnosis-1"
                                >
                            ...
                            <div
                                ...
                                :data-bs-parent="'#diagnosis-' + index"
                            >
                                <div class="accordion-body">
                                    ...
                                    <p class="mt-3 fs-5 text-gray-700">
                                        {{
                                            $t(
                                                "history.encounter_detail.chiefComplain"
                                            )
                                        }}
                                        :
                                    </p>
                                    ...
                                    <p class="mt-3 fs-5 text-gray-700">
                                        {{
                                            $t(
                                                "history.encounter_detail.currentHistory"
                                            )
                                        }}
                                        :
                                    </p>
                                    ...
                                    <p class="mt-3 fs-5 text-gray-700">
                                        {{
                                            $t(
                                                "history.encounter_detail.medikamentosaHistory"
                                            )
                                        }}
                                        :
                                    </p>
                                    ...
                                    <p class="mt-3 fs-5 text-gray-700">
                                        {{
                                            $t(
                                                "history.encounter_detail.generalCondition"
                                            )
                                        }}
                                        :
                                    </p>
                                    ...
                                    <p class="mt-3 fs-5 text-gray-700">
                                        {{
                                            $t(
                                                "history.encounter_detail.conscious"
                                            )
                                        }}
                                        :
                                    </p>
                                    ...
                                    <p class="mt-3 fs-5 text-gray-700">
                                        {{
                                            $t(
                                                "history.encounter_detail.otherExamination"
                                            )
                                        }}
                                        :
                                    </p>
                                    ...
                                    <!-- <p class="mt-3 fs-5 text-gray-700">
                                        {{
                                            $t("history.encounter_detail.notes")
                                        }}
                                        :
                                    </p>
                                    <p class="mt-2 fs-5">
